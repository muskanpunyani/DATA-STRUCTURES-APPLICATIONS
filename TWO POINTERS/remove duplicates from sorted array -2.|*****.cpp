...
class Solution {
public:
    // extended version of removing duplicates from sorted array
    // the only diff is that the final array should have 2 instances of any val
...
*/
    ...
    int removeDuplicates(vector<int>& nums) {
        ...
        for(i=K; i<len; ++i)
        {
            ...
            {
                nums[last] = nums[i]; // note it is last-K
                last++;
            }
        }
        return last;
